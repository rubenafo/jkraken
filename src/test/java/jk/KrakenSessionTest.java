...
public class KrakenSessionTest {
    ...
    public void session_receives_subscribed_msg (){
        ...
        assertEquals(1, kservice.getSessionData().getSubscribedChannels().size());
        val channel = kservice.getSessionData().getSubscribedChannels().get(274);
    ...
    public void session_receives_ticker_data_msg() {
        ...
        kservice.handleTextMessage(this.session, new TextMessage(input2));
        val tickerData = kservice.getSessionData().getTickerData();
    ...
    public void session_unsubscribes_channel () {
        ...
        kservice.handleTextMessage(this.session, new TextMessage(input));
        val channels = kservice.getSessionData().getSubscribedChannels();
