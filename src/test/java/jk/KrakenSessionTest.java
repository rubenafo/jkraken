...
//    }
    ...
    public void session_unsubscribes_channel () {
        ...
        var session = new KrakenWebSocketService(null);
        session.handleTextMessage(null, new TextMessage(input));
        val channels = session.getSessionData().getSubscribedChannels();
    ...
    public void session_understands_ownTrades () {
        ...
        val session = new KrakenWebSocketService(mock(PrivateTokenService.class));
        session.handleTextMessage(null, new TextMessage(input));
    }
}
