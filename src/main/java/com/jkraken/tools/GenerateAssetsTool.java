...
import com.jkraken.entities.AssetPairs;
...
public class GenerateAssetsTool {
    ...
    private static void createEnum(AssetPairs assetPairs) {
        ...
        JavaFile javaFile = JavaFile.builder("com.jkraken.entities", assetEnums).build();

        System.out.println("Creating AssetPairsEnum.java file under com.jkraken.entities...");
